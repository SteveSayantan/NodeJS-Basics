...
//Jodi imported module er moddhe kono amon kono function thake jeta already call kora hoyeche inside that module, in that case we can use require and see that code running for the current file without even calling it and assigning the value of it to a variable. Even though that function was not exported explicitly by imported module .
